...
if (error) {
  console.error("❌ Error al subir archivo:", error.message);
    ...
    const { data: galeriaData, error: galeriaError } = await Conexion
      ...
      .insert([
        {
          Id_Coleccion: coleccionData.Id, // 👈 el ID que devolvió la colección
          Titulo: archivo.name,
  ...
  return (
    <>
      <section className="d-flex">
          ...
          <section className="d-flex flex-column w-100 h-25 align-items-center justify-content-between p-3">
            <section className="d-flex justify-content-between w-75 ">
              ...
              <section className="w-25 d-flex justify-content-between">
                ...
                <button onClick={setContinuar} className="btn btn-dark">Continue</button>
              </section>
            </section>
            <section className="d-flex flex-column h-50 w-75 align-items-center">
              {
                preview ? ( // 👈 estado booleano
                  <>
        ...
        {/* <section style={{width:"20%",border:"1px solid green"}} className="d-flex flex-column align-items-center justify-content-center" >
          <section>
            <h4>Insert Block</h4>
          </section>
          
          <section className="d-flex d-flex align-items-center justify-content-center h-25">
            <img src="https://images.icon-icons.com/3455/PNG/512/picture_file_image_photo_gallery_icon_219497.png" className="w-25" alt="" />
            <button onClick={setGaleria} className="w-50 h-25">Galeria</button>
          </section>

        </section> */}

        {/* Esto es para poder guardar varias variables */}
        <section>
          {
            Galeria ? (
              <>
